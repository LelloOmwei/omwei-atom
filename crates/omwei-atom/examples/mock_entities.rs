...
pub fn create_ea_water_level(value_mm: u32, timestamp_us: u64) -> SemanticAtom {
    use omwei_atom::{PREDICATE_NORMAL, TELEMETRY_WATER_LEVEL_MM, TRUST_VERIFIED};
...
pub fn create_local_temperature(value_mm: u32, timestamp_us: u64) -> SemanticAtom {
    use omwei_atom::{PREDICATE_NORMAL, TELEMETRY_TEMPERATURE_C, TRUST_VERIFIED};
...
pub fn create_weather_precipitation(
    ...
    use omwei_atom::{PREDICATE_NORMAL, TELEMETRY_PRECIPITATION_MM};
